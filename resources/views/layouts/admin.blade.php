...
<body class="bg-gray-100">
    ...
    <!-- Sidebar -->
    <div class="flex">
        <div class="w-64 bg-gray-800 text-white h-screen p-5 fixed"> <!-- Made the sidebar fixed -->
            ...
            <ul>
                ...
                <li class="mb-2"><a href="{{route('admin.villas.index')}}" class="text-white hover:bg-gray-700 rounded-lg p-2 block">Properti Villa</a></li>
                <li class="mb-2"><a href="{{ route('actionlogout') }}" class="text-red-400 hover:bg-gray-700 rounded-lg p-2 block">Logout</a></li>
            </ul>
        </div>

        <!-- Main Content -->
        <div class="flex-1 p-6 ml-64"> <!-- Added margin-left to account for the fixed sidebar -->
            @yield('content')
        </div>
    </div>
