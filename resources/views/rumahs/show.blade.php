...
<div class="container mx-auto px-4 py-8">
    <div class="flex flex-col lg:flex-row lg:max-w-7xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div class="lg:w-1/2 p-6 bg-gray-100">
            <h3 class="text-2xl font-semibold text-gray-800 mb-6">Booking Form</h3>
            <form action="{{ route('rumahs.book', $rumah->id) }}" method="POST" class="space-y-6">
                ...
                <div class="flex items-center justify-center mb-4">
                    <p class="text-lg font-semibold text-gray-800">Total Harga: <span id="totalPrice">Rp {{ number_format($rumah->harga) }}</span></p>
                </div>
...
<script>
    ...
    // Function to update total price based on guests and dates
