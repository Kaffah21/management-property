    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="bg-gray-100 p-4 flex justify-between items-center">
            ...
            <a href="{{ route('admin.villas.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 flex items-center">
                <i class="fas fa-plus fs-2 mr-2"></i> Add Villa
            </a>
        </div>
        <div class="p-6">
            @if(session('success'))
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap flex space-x-2">
                            <a href="{{ route('admin.villas.edit', $villa) }}" class="bg-blue-500 text-white px-3 py-1 rounded-md hover:bg-blue-600 flex items-center" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
