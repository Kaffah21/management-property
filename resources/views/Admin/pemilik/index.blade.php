    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        <div class="bg-gray-100 p-4 flex justify-between items-center">
            ...
            <a href="{{ route('admin.pemilik.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 flex items-center">
                <i class="fas fa-plus fs-2 mr-2"></i> Add Owner
            </a>
        </div>
        <div class="p-6">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap flex space-x-4">
                            <div class="relative group">
                                <a href="{{ route('admin.pemilik.edit', $item->id) }}" class="bg-blue-500 text-white px-3 py-1 rounded-md hover:bg-blue-600 flex items-center" aria-label="Edit Villa">
                            ...
                            <div class="relative group">
                                <form action="{{ route('admin.pemilik.destroy', $item->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="bg-red-500 text-white px-3 py-1 rounded-md hover:bg-red-600 flex items-center" onclick="return confirm('Yakin ingin menghapus?')" aria-label="Hapus Villa">
