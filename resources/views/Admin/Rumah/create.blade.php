...
<div class="container mx-auto p-6">
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="bg-gray-100 p-4">
            <h3 class="text-xl font-semibold">Tambah home</h3>
        </div>
        <div class="p-6">
            <form action="{{ route('admin.rumah.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 font-semibold mb-2">Nama home</label>
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="{{ route('admin.rumah.index') }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-400">Kembali</a>
                </div>
            </form>
        </div>
    </div>
