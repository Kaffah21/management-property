        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach ($rumahs as $rumah)
                <div
                    ...
                    <img src="{{ Storage::url('rumah/' . $rumah->gambar) }}" class="w-full h-48 object-cover"
                        alt="{{ $rumah->nama }}">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 text-sm mb-4">
                            ...
                            <span class="font-semibold text-lg text-gray-800">Rp {{ number_format($rumah->harga) }} /
                                malam</span>
                        </p>
            ...
            @foreach ($villas as $villa)
                <div
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ route('villas.show', $rumah) }}"class="px-6 py-2 rounded-md border transition duration-300"
                        style="background-color: white; color: #049484; border: 1px solid #049484;"
                        onmouseover="this.style.backgroundColor='#049484'; this.style.color='white';"
                        onmouseout="this.style.backgroundColor='white'; this.style.color='#049484';">
                        Lihat Detail
